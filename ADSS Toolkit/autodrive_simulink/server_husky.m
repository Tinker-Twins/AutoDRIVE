classdef server_husky < WebSocketServer & handle
    % AutoDRIVE Husky Server
    ...
    methods
        function obj = server_husky(varargin)
            % Constructor
    ...
    methods (Access = protected)
        ...
        function onTextMessage(obj,conn,message)
            ...
            % Parse incoming data
            obj.husky_1.parse_data(in_data);            
            % Encode outgoing data as a JSON message
            out_data = obj.husky_1.generate_commands();
