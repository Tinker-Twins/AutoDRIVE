...
[RequireComponent(typeof (AutomobileController))]
public class CarAudio : MonoBehaviour
{
    ...
    private AutomobileController m_CarController; // Reference to car we are controlling


    private void StartSound()
    {
        // get the carcontroller (this will not be null as we have require component)
        m_CarController = GetComponent<AutomobileController>();
    ...
    private void Update()
    {
        ...
        if (m_StartedSound)
        {
            ...
            else
            {
                ...
                float accFade = Mathf.Abs(0.2f*m_CarController.fwdInput);
                float decFade = 1 - accFade;

                // get the high fade value based on the cars revs
                float highFade = Mathf.InverseLerp(0.2f, 0.8f, m_CarController.engineRPM/1000);
                ...
                m_LowAccel.volume = 0.1f*lowFade*accFade;
                m_LowDecel.volume = 0.1f*lowFade*decFade;
                m_HighAccel.volume = 0.1f*highFade*accFade;
                m_HighDecel.volume = 0.1f*highFade*decFade;
