...
{
    public class TrackTarget : AbstractTargetFollower
    {
        /*
        This script makes one object look at another,
        but with optional constraints which operate relative to
        this gameobject's initial rotation.

        Only rotates about local X and Y axes.
        ...
        */
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            // Tackle rotation about Y-axis first
            ...
            // Then recalculate new local target position for rotation about X-axis
