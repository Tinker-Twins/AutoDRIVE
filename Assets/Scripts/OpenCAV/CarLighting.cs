...
public class CarLighting : MonoBehaviour
{
    ...
    */
    ...
    private int HeadlightState = 0; // 0 = Disabled, 1 = Low Beam, 2 = High Beam, 3 = Parking Lights, 4 = Fog Lights, 5 = 1+3, 6 = 2+3, 7 = 1+4, 8 = 2+4, 9 = 1+3+4, 10 = 2+3+4
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.X)) // TODO: Add additional cases here
        {
            BrakesEngaged = true;
        }
        else
