'''
Testing two CSI cameras connected to a NVIDIA Jetson Orin Nano Developer Kit using OpenCV.
...
def camera_test():
    ...
    while cv2.getWindowProperty("Camera Test", 0) >= 0 :
        ...
        cv2.imshow("Camera Test", frame_0) # Display `Camera_0` frames only
        # cv2.imshow("Camera Test", frame_1) # Display `Camera_1` frames only
        # cv2.imshow("Camera Test", camera_frames) # Display stacked frames from `Camera_0` & `Camera_1`        
